...
- Companion panels per node or per document: rich-text Notes, Code blocks, a Decision Log, a whole-document Pad (with Notepad, Q&A, Diagrams, and Mind Map tabs)
...
- **Pad** — a whole-document workspace, separate from per-node Notes, with five tabs:
