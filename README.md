...
- Below 768px, this file redirects to hub.html, which only covers To-Dos and Journal — Meeting Notes, Library, Recap, and the outliner itself aren't reachable from a phone-sized screen yet. This is an intentional, staged rollout, not a bug; "Open full app" on hub.html is the escape hatch if you need the rest.
